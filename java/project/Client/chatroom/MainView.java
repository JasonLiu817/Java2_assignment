package project.Client.chatroom;


import project.Client.emojis.EmojiDisplayer;
...
import static project.Utils.Constants.CONTENT;
...
public class MainView implements ControlledStage, Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        labUserName.setText( model.getThisUser() );
        ...
        userGroup.getSelectionModel().selectedItemProperty().addListener((observable, oldValue, newValue) -> {
            ...
            if (user.getUserName().equals("[group]")) {
                ...
                if (!seletUser.equals(user.getUserName())) {
                    ...
                    labChatTip.setText("与 " + seletUser+"  聊天中");
                    // TODO: 2017/11/29
                }
            }
        });
    ...
    public void onEmojiBtnClcked() {
        ...
        stageController.loadStage(ClientLaucher.EmojiSelectorID, ClientLaucher.EmojiSelectorRes);
        stageController.setStage(ClientLaucher.EmojiSelectorID);
    }
